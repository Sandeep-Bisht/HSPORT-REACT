          ...
          <div className="row">
                    ...
                    <div className="single-footer-widget">
                      ...
                      <ul className="footer-contact-info px-0">
                        ...
                        <li>
                          ...
                          <Link to="mailto:info@nutrazik.com" target="_blank" className='footer-links f2'>
                            info@nutrazik.com
                          </Link>
                        </li>
                        <li >
                  ...
                  <div className="col-lg-3 col-sm-6 col-md-6 col-6">
                    <div className="single-footer-widget">
                      ...
                      <ul className="link-list footer-contact-info px-0">
                        <li>
                          <Link to="/aboutus" className='footer-links f2'>About Us</Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="/privacy&policy" className='footer-links f2'>Privacy Policy</Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="/shippingPolicy"className='footer-links f2'>Shipping Policy</Link>
                        </li>
                        <li>
                          <Link to="/return&refund" className='footer-links f2'>Return & Refund</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6 col-md-6 col-6">
                    <div className="single-footer-widget">
                      ...
                      <ul className="link-list footer-contact-info px-0">
                        <li>
                          <Link to="/Faq" className='footer-links f2'>FAQs</Link>
                        </li>
                        <li>
                            <Link to="/MyAccount" className='footer-links f2'>My Account</Link>
                          
                        </li>
                        <li>
                            <Link to="/UserOrder" className='footer-links f2'>Order History</Link>
                        </li>
  
                        <li>
                            <Link to="/WishList" className='footer-links f2'>Wishlist</Link>
                        </li>
                        <li>
                          <Link to="/support" className='footer-links f2'>Need Support?</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
