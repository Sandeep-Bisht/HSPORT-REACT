        ...
        <div className="row">
          <div className='col-md-6'>
            <div className='about-image'>
              <img src={About1} alt="about-image" className='img-fluid' />
            </div>
          </div>
          <div className='col-md-6'>
            <div className='about-text'>
              <h1 className='common-heading'>Our Story</h1>
              <p className='common-para f1 paragraph-footer text-justify'>
      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-md-8 mx-auto'>
            <div className='about-section'>
              <p className='common-para paragraph-footer f1 text-center pb-5'>
        ...
        <div className='row'>
          <div className='col-md-12'>
            <div className='about-section'>
             <img src={About2} alt="about-image" className='img-fluid'/>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='row align-item-center'>
          <div className='col-md-5 mx-auto'>
            <div className='our-vision-right-text'>
              ...
              <p className='common-para paragraph-footer f1 text-justify'>
          ...
          <div className='col-md-6'>
            <div className='our-vision-left-image'>
              <img src={About3} alt="about-image" className='img-fluid'/>
            </div>
          </div>
        </div>
        <div className='row'>
