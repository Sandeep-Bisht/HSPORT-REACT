        ...
        <div className="row">
          <div className="col-12">
            ...
            <h1 className='common-heading text-start'>
              ...
              <p className='common-para f1 paragraph-footer f1'>Welcome to Hindustan.com</p>

              <p className='common-para f1 paragraph-footer f1'>
                These terms and conditions outline the rules and regulations for
                the use of Hindustan's Website, located at https://Hindustan.com/.
              </p>

              <p className='common-para f1 paragraph-footer f1'>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Hindustan.giksindia.com if you
              ...
              <p className='common-para f1 paragraph-footer f1'>
                ...
                you agreed to use cookies in agreement with the Hindustan's
                Privacy Policy.{" "}
              </p>
              ...
              <p className='common-para f1 paragraph-footer f1'>
                ...
                Hindustan.giksindia.com. All intellectual property rights are
                reserved. You may access this from Hindustan.giksindia.com for
                your own personal use subjected to restrictions set in these
                terms and conditions.
              </p>

              <p className='common-para f1 paragraph-footer f1'>You must not:</p>
              <ul>
                <li className='paragraph-footer'>Republish material from Hindustan.giksindia.com</li>
                <li className='paragraph-footer'>
                  Sell, rent or sub-license material from Hindustan.giksindia.com
                </li>
                <li className='paragraph-footer'>
                  Reproduce, duplicate or copy material from
                  Hindustan.giksindia.com
                </li>
                <li className='paragraph-footer'>Redistribute content from Hindustan.giksindia.com</li>
              </ul>

              <p className='common-para f1 paragraph-footer f1'>This Agreement shall begin on the date hereof.</p>

              <p className='common-para f1 paragraph-footer f1'>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. Hindustan does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Hindustan,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Hindustan shall not be liable for
              ...
              <p className='common-para f1 paragraph-footer f1'>
                Hindustan reserves the right to monitor all Comments and to
                remove any Comments which can be considered inappropriate,
                offensive or causes breach of these Terms and Conditions.
              </p>

              <p className='common-para f1 paragraph-footer f1'>You warrant and represent that:</p>
              ...
              <p className='common-para f1 paragraph-footer f1'>
                You hereby grant Hindustan a non-exclusive license to use,
              ...
              <ul>
                <li className='paragraph-footer'>Government agencies.</li>
                <li className='paragraph-footer'>Search engines.</li>
                <li className='paragraph-footer'>News organizations.</li>
                <li className='paragraph-footer'>
              ...
              <ul>
                ...
                <li className='paragraph-footer'>dot.com community sites.</li>
                <li className='paragraph-footer'>associations or other groups representing charities.</li>
                <li className='paragraph-footer'>online directory distributors.</li>
                <li className='paragraph-footer'>internet portals.</li>
                <li className='paragraph-footer'>accounting, law and consulting firms.</li>
                <li className='paragraph-footer'>educational institutions and trade associations.</li>
              </ul>
              ...
              <p className='common-para f1 paragraph-footer f1'>
                ...
                of Hindustan; and (d) the link is in the context of general
              ...
              <p className='common-para f1 paragraph-footer f1'>
                ...
                by sending an e-mail to Hindustan. Please include your name, your
              ...
              <ul>
                <li className='paragraph-footer'>By use of our corporate name.</li>
                <li className='paragraph-footer'>
              ...
              <p className='common-para f1 paragraph-footer f1'>
                No use of Hindustan's logo or other artwork will be allowed for
